...
KiroX 是一款基于 [Wails v2](https://wails.io) 构建的桌面应用，用于自动化完成 AWS Builder ID 账号的批量注册流程。支持 Outlook 邮箱池、MoeMail 临时邮箱以及自部署的 Cloud-Mail 三种邮件来源，内置浏览器指纹模拟、并发控制、代理支持和自动更新。
